...
def create_aggregate_features(df):
    ...
    agg_df.columns = ['CustomerId', 'total_amount', 'avg_amount', 'txn_count', 'amount_std', 'last_txn_time']
...
def cluster_customers(rfm):
    ...
    high_risk_cluster = cluster_summary['recency'].idxmax()  # Cluster with highest recency
...
def build_pipeline(target_col='is_high_risk'):
    ...
    numeric_features = ['total_amount', 'avg_amount', 'txn_count', 'amount_std', 'txn_hour', 'txn_day', 'txn_month']
